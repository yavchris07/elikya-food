  ...
  return (
    ...
    <section className="section-padding bg-white">
      <div className="container-custom w-[70%] mx-auto py-8 max-sm:w-[90%]">
        ...
        >
          <h2 className="heading-2 text-primary mb-4 text-green-800 text-[32px] max-sm:text-[22px]">Who We Are</h2>
          <p className="text-[26px] text-gray-500 max-sm:text-[18px]">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="heading-3 mb-6 text-green-800 text-[28px] max-sm:text-[22px]">Our Approach</h3>
            ...
            <div className="mt-8 p-6 bg-white rounded-xl shadow-lg">
              <h4 className="font-bold text-green-800 mb-2 text-[28px] max-sm:text-[22px]">Our Mission</h4>
              <p className="text-gray-500 text-[21px] max-sm:text-[16px]">
            ...
            <div className="mt-6 p-6 bg-white rounded-xl shadow-lg">
              <h4 className="font-bold text-green-800 mb-2 text-[28px] max-sm:text-[22px]">Our Vision</h4>
              <p className="text-gray-500 text-[21px] max-sm:text-[16px]">
        ...
        >
          <h3 className="heading-3 mb-8 text-green-800 text-[28px] max-sm:text-[22px]">Core Values</h3>
          <div className="flex flex-wrap justify-center gap-8">
            {values.map((value, index) => (
              ...
              >
                ...
                <span className="font-semibold text-gray-500 text-[21px] max-sm:text-[16px]">{value.name}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
