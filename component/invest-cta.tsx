  ...
  return (
    <section className="section-padding bg-white">
      <div className="container-custom w-[70%] mx-auto py-8 max-sm:w-[90%]">
        ...
        >
          <h2 className="heading-2 text-green-800 mb-4 text-[32px] max-sm:text-[22px]">Massive Opportunity — Local to Global</h2>
          <p className="text-xl text-gray-500 max-w-2xl mx-auto text-[26px] max-sm:text-[16px]">
        ...
        >
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h3 className="heading-3 mb-6 text-green-800 text-[28px] max-sm:text-[22px]">We welcome:</h3>
            <ul className="space-y-4">
              {[
                ...
                <li key={index} className="flex items-start gap-3">
                  <span className="text-gray-500 font-bold text-[21px] max-sm:text-[16px]">•</span>
                  <span className='text-gray-500 text-[21px] max-sm:text-[16px]'>{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg">
            <h3 className="heading-3 mb-6 text-green-800 text-[28px] max-sm:text-[22px]">Partnership Opportunities</h3>
            <div className="space-y-4">
              <div className="p-4 bg-accent rounded-lg">
                <h4 className="font-bold text-primary mb-2 text-green-800 text-[21px] max-sm:text-[16px]">Buyers</h4>
                <p className="text-gray-500 text-[21px] max-sm:text-[16px]">Hotels, restaurants, supermarkets seeking reliable, high-quality supply</p>
              </div>
              <div className="p-4 bg-accent rounded-lg">
                <h4 className="font-bold text-primary mb-2 text-green-800 text-[21px] max-sm:text-[16px]">Farmers</h4>
                <p className="text-gray-500 text-[21px] max-sm:text-[16px]">Join our network for better prices, storage, training, and market access</p>
              </div>
              <div className="p-4 bg-accent rounded-lg">
                <h4 className="font-bold text-primary mb-2 text-green-800 text-[21px] max-sm:text-[16px]">Corporates & Foundations</h4>
                <p className="text-gray-500 text-[21px] max-sm:text-[16px]">Collaborate on nutrition, sustainability, or farmer support initiatives</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h3 className="heading-3 mb-8 text-gray-500 text-[21px] max-sm:text-[16px]">Ready to build a more sustainable food future together?</h3>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center text-[21px] max-sm:text-[16px]">
            <Link
              href="#"
