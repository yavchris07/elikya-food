      ...
      <div className="relative container-custom text-white z-10">
        ...
        >
          <h1 className="heading-1 mb-6">
            Transforming Africa&apos;s Food Future — From Farm to Table, No Waste
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
            Elikya Foods connects smallholder farmers to urban markets in the DRC, 
            slashing post-harvest losses, boosting incomes, and delivering fresh, 
            high-quality produce and protein to growing cities like Kinshasa.
          </p>

          <p className="text-lg mb-12 text-secondary font-semibold">
            Building resilient supply chains for healthier communities and sustainable growth.
          </p>
          ...
          <div className="flex gap-8 mt-16">
            <div className="flex items-center gap-2">
              ...
              <span>40-50% Loss Reduction</span>
            </div>
            <div className="flex items-center gap-2">
